      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
            ...
            <div className="flex-shrink-0 flex items-center">
              ...
              <div className="flex items-center justify-center">
                <img
                  ...
                  alt="Flito"
                />
                <h1 className="text-2xl font-bold" style={style.navTitle}>
                  Flito
                </h1>
              </div>
            </div>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button className="bg-yellow-800 p-1 rounded-full text-gray-100 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-yellow-800 focus:ring-white">
